...
import { ArrowLeft, Server, Activity, ExternalLink } from 'lucide-react';
      ...
      <section className="border-b border-zinc-800 bg-zinc-900/50 px-4 py-6 md:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl font-black text-zinc-100 md:text-4xl flex items-center gap-3">
            <Server className="h-8 w-8" /> Hosting Status
          </h1>
          <p className="mt-2 text-sm text-zinc-400">Monitor Vercel hosting platform availability and incidents</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl space-y-8">
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-6">
            ...
            <div className="space-y-3 text-sm text-zinc-300">
              <p>For the most up-to-date information about Vercel's service status, visit their official status page:</p>
              <a 
              ...
              >
                <span className="text-lg font-bold">status.vercel.com</span>
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-6">
            ...
            <div className="space-y-3 text-sm text-zinc-300">
              <p>Vercel status monitors the availability of:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>Edge network and CDN</li>
                <li>Deployment infrastructure</li>
                <li>Serverless functions</li>
                <li>Database connections</li>
                <li>Build and CI/CD pipeline</li>
                <li>DNS and domain services</li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-6">
            ...
            <div className="space-y-3 text-sm text-zinc-300">
              <p>Vercel outages may affect:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>Website availability and loading</li>
                <li>API endpoint responses</li>
                <li>New deployments and updates</li>
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-6">
            ...
            <div className="space-y-2 text-sm text-zinc-300">
              <div className="flex justify-between py-2 border-b border-zinc-800">
                ...
                <a href="https://status.vercel.com" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">status.vercel.com</a>
              </div>
              <div className="flex justify-between py-2 border-b border-zinc-800">
                <span>API Status:</span>
                <a href="https://status.vercel.com/api" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">API Status</a>
              </div>
              <div className="flex justify-between py-2">
                <span>Twitter Updates:</span>
                <a href="https://twitter.com/vercelstatus" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">@vercelstatus</a>
              </div>
            </div>
          </div>
        </div>
