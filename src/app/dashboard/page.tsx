              ...
              {isPro ? (
                <div className="space-y-4">
                  ...
                  <div className="pt-4 flex gap-3">
                    ...
                    <Link
                      href="/pricing"
                      className="flex-1 h-10 px-4 rounded-lg border border-teal-900/50 bg-teal-950/30 hover:bg-teal-950/50 text-teal-300 text-xs font-bold uppercase flex items-center justify-center transition"
                    >
                      Change Plan
                    </Link>
                  </div>
